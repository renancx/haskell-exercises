...
-- typeof ctx para operação aritmética de subtração
typeof ctx (Sub e1 e2) = case (typeof ctx e1, typeof ctx e2) of
    (Just TNum, Just TNum) -> Just TNum
    _ -> Nothing

-- typeof ctx para operação aritmética de multiplicação
typeof ctx (Mul e1 e2) = case (typeof ctx e1, typeof ctx e2) of
    (Just TNum, Just TNum) -> Just TNum
    _ -> Nothing

-- typeof ctx para operação lógica de or
typeof ctx (Or e1 e2) = case (typeof ctx e1, typeof ctx e2) of
    (Just TBool, Just TBool) -> Just TBool
    _ -> Nothing

-- typeof ctx para operação lógica de xor

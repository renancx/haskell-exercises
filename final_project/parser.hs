...
happyExpList = Happy_Data_Array.listArray (0,51) ([14352,32,0,16128,0,0,1024,61454,4131,8248,16496,32992,448,897,1794,0,0,0,0,0,0,33024,64515,1040,14,0,0
	])
...
action_23 (6) = happyShift action_8
